[![Build Status](https://dev.azure.com/shannonmurray/Test/_apis/build/status/ShannonAl.pipelines-dotnet-core)](https://dev.azure.com/shannonmurray/Test/_build/latest?definitionId=1)# Sample ASP.NET Core application for Azure Pipelines docs
